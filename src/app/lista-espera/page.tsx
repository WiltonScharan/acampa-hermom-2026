        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th className="text-left px-4 py-3 font-semibold text-gray-600 min-w-[160px]">Nome do Casal</th>
              <th className="text-left px-4 py-3 font-semibold text-gray-600 whitespace-nowrap min-w-[140px]">Telefone</th>
              <th className="text-left px-4 py-3 font-semibold text-gray-600 min-w-[120px]">Observações</th>
